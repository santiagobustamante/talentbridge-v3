...
const cities = ['Bogotá, D.C.', 'Medellín, Antioquia', 'Cali, Valle del Cauca', 'Barranquilla, Atlántico', 'Cartagena de Indias, Bolívar', 'Bucaramanga, Santander', 'Cúcuta, Norte de Santander', 'Villavicencio, Meta', 'Pereira, Risaralda', 'Manizales, Caldas', 'Armenia, Quindío', 'Santa Marta, Magdalena', 'Ibagué, Tolima', 'Pasto, Nariño', 'Montería, Córdoba', 'Neiva, Huila', 'Popayán, Cauca', 'Tunja, Boyacá', 'Valledupar, Cesar', 'Riohacha, La Guajira', 'Remoto'];
...
const jobTemplates: JobTemplate[] = [
  ...
  // Ciberseguridad
  { title: 'Analista de Ciberseguridad', description: 'Buscamos Analista de Ciberseguridad para proteger la infraestructura y los datos de la organización. Monitorearás amenazas y responderás a incidentes de seguridad.', requirements: 'Experiencia en seguridad informática, gestión de firewalls, SIEM, análisis de vulnerabilidades, normativa ISO 27001.', responsibilities: 'Monitorear alertas de seguridad, analizar y contener incidentes, ejecutar escaneos de vulnerabilidades, documentar hallazgos y proponer remediaciones.', skillsRequired: 'Ciberseguridad, Firewalls, SIEM, ISO 27001, Análisis de vulnerabilidades, Redes, Linux, Incident Response' },
  { title: 'Especialista en Seguridad Informática', description: 'Especialista en Seguridad Informática para liderar la estrategia de protección de sistemas y datos de la compañía.', requirements: 'Experiencia en arquitectura de seguridad, gestión de identidades (IAM), cifrado, cumplimiento normativo (ISO 27001, GDPR), auditorías de seguridad.', responsibilities: 'Diseñar políticas de seguridad, liderar auditorías, implementar controles de acceso, capacitar al equipo en buenas prácticas, coordinar respuesta ante incidentes.', skillsRequired: 'Seguridad informática, IAM, ISO 27001, Auditoría, Cifrado, Cumplimiento normativo, Gestión de riesgos, Redes' },
  { title: 'Ingeniero de Seguridad Ofensiva (Pentester)', description: 'Pentester para identificar vulnerabilidades antes que un atacante real. Ejecutarás pruebas de penetración sobre aplicaciones e infraestructura.', requirements: 'Experiencia con Metasploit, Burp Suite, Nmap, OWASP Top 10, scripting en Python o Bash, certificaciones deseables (OSCP, CEH).', responsibilities: 'Ejecutar pruebas de penetración internas y externas, explotar vulnerabilidades de forma controlada, documentar hallazgos técnicos, recomendar remediaciones.', skillsRequired: 'Pentesting, Metasploit, Burp Suite, OWASP, Python, Bash, Nmap, Ethical Hacking' },
  { title: 'Analista SOC (Security Operations Center)', description: 'Analista SOC para monitoreo 24/7 de eventos de seguridad. Serás la primera línea de defensa ante actividad sospechosa en la red.', requirements: 'Conocimientos en SIEM (Splunk, QRadar), análisis de logs, respuesta a incidentes, protocolos de red, trabajo por turnos.', responsibilities: 'Monitorear dashboards de seguridad en tiempo real, triage de alertas, escalar incidentes críticos, mantener bitácora de eventos.', skillsRequired: 'SOC, SIEM, Splunk, Análisis de logs, Incident Response, Redes, TCP/IP, Seguridad' },
  { title: 'Arquitecto de Seguridad', description: 'Arquitecto de Seguridad para diseñar la estrategia de protección de la infraestructura cloud y on-premise de la empresa.', requirements: 'Experiencia sólida en arquitectura de seguridad cloud (AWS/Azure), Zero Trust, DevSecOps, gestión de vulnerabilidades a escala.', responsibilities: 'Diseñar arquitecturas seguras, integrar seguridad en el pipeline de CI/CD (DevSecOps), definir estándares de la organización, asesorar a equipos de desarrollo.', skillsRequired: 'Arquitectura de seguridad, AWS, Azure, DevSecOps, Zero Trust, Kubernetes, Docker, Cloud Security' },

  // Desarrollo y arquitectura de software (variantes adicionales)
  { title: 'Desarrollador NestJS', description: 'Buscamos Desarrollador especializado en NestJS para evolucionar una plataforma de microservicios en producción. Trabajarás con un stack moderno de TypeScript de punta a punta.', requirements: 'Experiencia con NestJS, TypeScript, PostgreSQL, Prisma ORM, arquitectura de microservicios, Docker, testing con Jest.', responsibilities: 'Diseñar y mantener microservicios NestJS, modelar esquemas con Prisma, optimizar consultas, participar en revisiones de arquitectura.', skillsRequired: 'NestJS, TypeScript, PostgreSQL, Prisma, Docker, Microservicios, Git, Jest' },
  { title: 'Ingeniero de Software Senior', description: 'Ingeniero de Software Senior para liderar técnicamente el desarrollo de productos escalables construidos sobre microservicios en Kubernetes.', requirements: 'Mínimo 4 años de experiencia en desarrollo backend (Java o Node.js/NestJS), Docker, Kubernetes, PostgreSQL, diseño de sistemas distribuidos.', responsibilities: 'Liderar decisiones de arquitectura, mentorear al equipo, revisar diseños técnicos, garantizar escalabilidad y buenas prácticas de ingeniería.', skillsRequired: 'Java, NestJS, TypeScript, Kubernetes, Docker, PostgreSQL, Microservicios, Arquitectura de software' },
  { title: 'Desarrollador .NET', description: 'Desarrollador .NET para aplicaciones empresariales críticas. Trabajarás en un equipo ágil con foco en calidad y buenas prácticas.', requirements: 'Experiencia con C#, .NET Core, Entity Framework, SQL Server, arquitectura limpia, pruebas unitarias.', responsibilities: 'Desarrollar servicios y APIs en .NET, mantener aplicaciones existentes, escribir pruebas automatizadas, participar en ceremonias ágiles.', skillsRequired: '.NET, C#, Entity Framework, SQL Server, REST APIs, Git, Azure, Testing' },
  { title: 'Desarrollador PHP / Laravel', description: 'Desarrollador PHP con experiencia en Laravel para mantener y evolucionar plataformas web de comercio electrónico.', requirements: 'Experiencia con PHP, Laravel, MySQL, APIs REST, Composer, control de versiones con Git.', responsibilities: 'Desarrollar y mantener módulos en Laravel, integrar pasarelas de pago, optimizar consultas, corregir incidencias en producción.', skillsRequired: 'PHP, Laravel, MySQL, REST APIs, Git, Composer, HTML, CSS' },
  { title: 'Desarrollador Mobile (Flutter)', description: 'Desarrollador Mobile para construir aplicaciones multiplataforma con Flutter, desde el diseño hasta la publicación en las tiendas.', requirements: 'Experiencia con Flutter, Dart, integración de APIs REST, publicación en Google Play y App Store, gestión de estado (Provider/Bloc).', responsibilities: 'Desarrollar pantallas y funcionalidades en Flutter, integrar con backend vía REST, optimizar rendimiento, publicar y mantener versiones en tiendas.', skillsRequired: 'Flutter, Dart, REST APIs, Firebase, Git, Mobile UI, Provider, Bloc' },
  { title: 'Desarrollador Vue.js', description: 'Desarrollador Vue.js para un equipo de producto ágil, construyendo interfaces reactivas para una plataforma SaaS en crecimiento.', requirements: 'Experiencia con Vue 3, Composition API, Vuex o Pinia, TypeScript, consumo de APIs REST.', responsibilities: 'Desarrollar componentes con Vue 3, gestionar estado de la aplicación, colaborar con diseño UX/UI, escribir pruebas con Vitest.', skillsRequired: 'Vue.js, TypeScript, Pinia, REST APIs, CSS, Git, Vitest, HTML' },

  // Sistemas, cloud e infraestructura
  { title: 'Ingeniero de Sistemas Senior', description: 'Ingeniero de Sistemas Senior para liderar la infraestructura tecnológica de una organización en expansión, combinando administración de sistemas con proyectos de modernización.', requirements: 'Experiencia sólida en administración de servidores Linux/Windows, virtualización, redes, y proyectos de migración a la nube.', responsibilities: 'Liderar el equipo de infraestructura, planificar migraciones a la nube, definir estándares de seguridad, supervisar el soporte de segundo y tercer nivel.', skillsRequired: 'Linux, Windows Server, Redes, Virtualización, Cloud, VMware, Seguridad, Liderazgo técnico' },
  { title: 'Administrador de Sistemas Linux', description: 'Administrador de Sistemas especializado en entornos Linux para garantizar la disponibilidad y el rendimiento de la infraestructura de producción.', requirements: 'Experiencia con administración de Linux (Ubuntu/RHEL), scripting en Bash, monitoreo, gestión de contenedores Docker.', responsibilities: 'Administrar servidores Linux en producción, automatizar tareas con scripts, monitorear disponibilidad, aplicar parches de seguridad.', skillsRequired: 'Linux, Bash, Docker, Monitoreo, Redes, Seguridad, Ansible, Shell Scripting' },
  { title: 'Ingeniero DevOps Senior', description: 'Ingeniero DevOps Senior para liderar la estrategia de CI/CD e infraestructura como código de una plataforma en Kubernetes.', requirements: 'Experiencia sólida con Kubernetes, Docker, Terraform, pipelines CI/CD, AWS o GCP, observabilidad (Prometheus/Grafana).', responsibilities: 'Diseñar arquitectura de despliegue en Kubernetes, automatizar infraestructura con Terraform, optimizar pipelines CI/CD, liderar prácticas de observabilidad.', skillsRequired: 'Kubernetes, Docker, Terraform, CI/CD, AWS, Prometheus, Grafana, IaC' },
  { title: 'Site Reliability Engineer (SRE)', description: 'SRE para garantizar la confiabilidad, escalabilidad y rendimiento de nuestros sistemas en producción a gran escala.', requirements: 'Experiencia con Kubernetes, observabilidad, gestión de incidentes, automatización, cultura de SLIs/SLOs.', responsibilities: 'Definir y monitorear SLIs/SLOs, liderar postmortems de incidentes, automatizar tareas operativas, mejorar la resiliencia de los sistemas.', skillsRequired: 'Kubernetes, SRE, Observabilidad, Incident Response, Docker, Python, Prometheus, Automatización' },
  { title: 'Arquitecto Cloud (AWS)', description: 'Arquitecto Cloud para diseñar soluciones escalables y seguras sobre AWS para clientes empresariales.', requirements: 'Certificación AWS (Solutions Architect deseable), experiencia en diseño de arquitecturas cloud, contenedores, redes y seguridad en AWS.', responsibilities: 'Diseñar arquitecturas cloud escalables, optimizar costos, asesorar a equipos de desarrollo, definir estándares de seguridad en AWS.', skillsRequired: 'AWS, Cloud Architecture, Kubernetes, Docker, Terraform, Seguridad, Redes, IaC' },

  // Datos e inteligencia artificial
  { title: 'Ingeniero de Machine Learning', description: 'Ingeniero de Machine Learning para diseñar y poner en producción modelos predictivos que impacten decisiones de negocio.', requirements: 'Experiencia con Python, scikit-learn, TensorFlow o PyTorch, MLOps, despliegue de modelos en producción.', responsibilities: 'Entrenar y evaluar modelos de ML, poner modelos en producción, colaborar con Data Engineering, monitorear el desempeño de los modelos.', skillsRequired: 'Python, Machine Learning, TensorFlow, PyTorch, MLOps, SQL, Docker, Estadística' },
  { title: 'Científico de Datos', description: 'Científico de Datos para extraer insights accionables de grandes volúmenes de información y apoyar decisiones estratégicas.', requirements: 'Experiencia con Python, estadística aplicada, modelos predictivos, SQL, visualización de datos, comunicación de resultados a negocio.', responsibilities: 'Analizar conjuntos de datos complejos, construir modelos predictivos, comunicar hallazgos a stakeholders, colaborar con equipos de producto.', skillsRequired: 'Python, Estadística, Machine Learning, SQL, Pandas, Visualización, Power BI, Comunicación' },
  { title: 'Ingeniero de Inteligencia Artificial', description: 'Ingeniero de IA para integrar modelos de lenguaje y soluciones de IA generativa en productos de la compañía.', requirements: 'Experiencia con Python, APIs de LLMs (OpenAI, DeepSeek o similares), prompt engineering, arquitectura de agentes, bases de datos vectoriales.', responsibilities: 'Diseñar integraciones con modelos de lenguaje, optimizar prompts, construir pipelines de IA generativa, evaluar calidad de las respuestas.', skillsRequired: 'Python, LLM, Prompt Engineering, IA Generativa, APIs REST, Bases de datos vectoriales, LangChain, NLP' },

  // Liderazgo técnico y producto
  { title: 'Tech Lead', description: 'Tech Lead para liderar un equipo de desarrollo full stack, combinando responsabilidades técnicas y de mentoría.', requirements: 'Experiencia liderando equipos técnicos, dominio de Angular/NestJS o stack similar, arquitectura de software, mentoría de desarrolladores junior.', responsibilities: 'Liderar decisiones técnicas del equipo, revisar arquitectura y código, mentorear desarrolladores, coordinar con Product Owner las entregas.', skillsRequired: 'Liderazgo técnico, Angular, NestJS, TypeScript, Arquitectura de software, Mentoría, Docker, Git' },
  { title: 'Arquitecto de Software', description: 'Arquitecto de Software para definir la arquitectura técnica de una plataforma de microservicios en crecimiento acelerado.', requirements: 'Experiencia diseñando arquitecturas de microservicios, patrones de diseño, Kubernetes, bases de datos relacionales, liderazgo técnico transversal.', responsibilities: 'Definir arquitectura de referencia, evaluar decisiones tecnológicas, asegurar escalabilidad y mantenibilidad, acompañar a los equipos de desarrollo.', skillsRequired: 'Arquitectura de software, Microservicios, Kubernetes, PostgreSQL, Patrones de diseño, Docker, Liderazgo técnico, Java' },
  { title: 'Scrum Master', description: 'Scrum Master para facilitar la entrega ágil de un equipo de desarrollo de producto multidisciplinario.', requirements: 'Certificación Scrum (CSM o similar) deseable, experiencia facilitando ceremonias ágiles, gestión de impedimentos, métricas ágiles.', responsibilities: 'Facilitar ceremonias Scrum, remover impedimentos del equipo, dar seguimiento a métricas ágiles, promover la mejora continua.', skillsRequired: 'Scrum, Kanban, Jira, Facilitación, Métricas ágiles, Comunicación, Gestión de equipos, Mejora continua' },
  { title: 'QA Automation Engineer', description: 'QA Automation Engineer para construir y mantener la suite de pruebas automatizadas de una plataforma en producción.', requirements: 'Experiencia con Cypress o Playwright, TypeScript, integración de pruebas en pipelines CI/CD, pruebas de API con Postman.', responsibilities: 'Diseñar y mantener pruebas automatizadas end-to-end, integrar pruebas al pipeline CI/CD, dar seguimiento a la cobertura de pruebas, reportar defectos.', skillsRequired: 'Cypress, Playwright, TypeScript, CI/CD, Postman, Testing, Git, QA' },
...
function generateJobTitleVariation(
  template: JobTemplate,
  company: { companyProfile?: { city?: string | null; sector?: string | null } | null },
): JobTemplate {
  const city = company.companyProfile?.city;
  const sector = company.companyProfile?.sector;
  const suffixes = [
    city ? ` - ${city}` : '', sector ? ` - Área ${sector}` : '', ` (${randomPick(['Híbrido', 'Remoto', 'Presencial'])})`,
...
async function main() {
  ...
  for (const [status, target] of Object.entries(targetPerStatus)) {
    for (let i = 0; i < target; i++) {
      ...
      const variation = generateJobTitleVariation(template, company);
